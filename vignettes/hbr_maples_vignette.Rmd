...
Both watershed distributions appear to be normally distributed according to the density and Q-Q plots with no strong skewness nor kurtosis. Now we can use `var.test` to see if they have equal variances. 
