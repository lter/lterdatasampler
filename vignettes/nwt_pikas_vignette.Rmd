...
```{r pikas, echo=FALSE, fig.cap="LTER researcher releasing a pika at the Niwot site, LTER CC BY-SA 4.0", fig.align='center'}
knitr::include_graphics(here::here("man","figures","nwt_pikas_img.jpg"))
```
