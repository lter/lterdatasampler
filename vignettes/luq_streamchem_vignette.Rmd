---
title: "Luquillo Mountains of Puerto Rico (LUQ LTER)"
subtitle: "Impacof hurricane Hugo on Stream chemistry for Quebrada Sonadora site"
...
- How to use long format to create facette plots
...
<figure style="text-align:center;">
  <img src="../man/figures/luq_streamchem_img.jpeg" width=40% style="display:block; margin-left: auto; margin-right: auto;">
...
See the references below if you want to know more about hurricane impact on stream chemistry and explore various algotrhms to detect change point in a time-series!
