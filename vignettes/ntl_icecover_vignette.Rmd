---
title: "ntl_icecover and ntl_airtemp: Comparing Temperatures and Lake Ice in Madison, WI since the 19th Century (North Temperate Lakes LTER)"
...
ntl_full_join <- ntl_annual_avg %>% 
  full_join(by = "year", ntl_icecover)
